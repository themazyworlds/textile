...
class Clipboard(Yarn):
    ...
    @strand(description="Read the current text content from the system clipboard.", tier="observe")
    ...
    @strand(description="Copy text content into the system clipboard.", tier="interact")
    ...
    @strand(description="Clear all content from the system clipboard.", tier="interact")
